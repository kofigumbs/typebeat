...
impl FaustDsp for reverb {
	...
	fn instance_constants(&mut self, sample_rate: i32) {
		...
		self.iConst3 = ((0.0353061222 * fConst0) as i32);
		self.iConst4 = ((0.033809524 * fConst0) as i32);
		self.iConst5 = ((0.0322448984 * fConst0) as i32);
		self.iConst6 = ((0.0366666652 * fConst0) as i32);
		...
		self.iConst20 = (self.iConst8 + 23);
		self.iConst21 = (self.iConst9 + 23);
		self.iConst22 = (self.iConst10 + 23);
		self.iConst23 = (self.iConst6 + 23);
		self.iConst24 = (self.iConst3 + 23);
		self.iConst25 = (self.iConst4 + 23);
		self.iConst26 = (self.iConst5 + 23);
