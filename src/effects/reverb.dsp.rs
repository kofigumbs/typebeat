...
impl FaustDsp for reverb {
	...
	fn instance_constants(&mut self, sample_rate: i32) {
		...
		self.iConst4 = ((0.0269387756 * fConst0) as i32);
		self.iConst5 = ((0.0289569162 * fConst0) as i32);
		self.iConst6 = ((0.0307482984 * fConst0) as i32);
		self.iConst7 = ((0.0322448984 * fConst0) as i32);
		self.iConst8 = ((0.033809524 * fConst0) as i32);
		self.iConst9 = ((0.0353061222 * fConst0) as i32);
		self.iConst10 = ((0.0366666652 * fConst0) as i32);
		...
		self.fConst19 = (self.iConst3 as F32);
		self.fConst20 = (self.iConst4 as F32);
		self.fConst21 = (self.iConst5 as F32);
		self.fConst22 = (self.iConst6 as F32);
		self.fConst23 = (self.iConst7 as F32);
		self.fConst24 = (self.iConst8 as F32);
		self.fConst25 = (self.iConst9 as F32);
		self.fConst26 = (self.iConst10 as F32);
		self.fConst27 = (iConst11 as F32);
		self.fConst28 = (iConst13 as F32);
		self.fConst29 = (iConst15 as F32);
		self.fConst30 = (iConst17 as F32);
	}
	...
	fn build_user_interface_static(ui_interface: &mut dyn UI<Self::T>) {
		...
		ui_interface.add_num_entry("reverbFeed", ParamIndex(0), 25.0, 0.0, 50.0, 10.0);
		ui_interface.add_num_entry("reverbGain", ParamIndex(1), 25.0, 0.0, 50.0, 10.0);
		ui_interface.add_num_entry("reverbSpace", ParamIndex(2), 25.0, 0.0, 50.0, 10.0);
	...
	fn compute(&mut self, count: i32, inputs: &[&[Self::T]], outputs: &mut[&mut[Self::T]]) {
		...
		let mut iSlow3: i32 = ((self.fConst19 + fSlow2) as i32);
		let mut iSlow4: i32 = ((self.fConst20 + fSlow2) as i32);
		let mut iSlow5: i32 = ((self.fConst21 + fSlow2) as i32);
		let mut iSlow6: i32 = ((self.fConst22 + fSlow2) as i32);
		let mut iSlow7: i32 = ((self.fConst23 + fSlow2) as i32);
		let mut iSlow8: i32 = ((self.fConst24 + fSlow2) as i32);
		let mut iSlow9: i32 = ((self.fConst25 + fSlow2) as i32);
		let mut iSlow10: i32 = ((self.fConst26 + fSlow2) as i32);
		let mut fSlow11: F32 = (fSlow2 + -1.0);
		let mut iSlow12: i32 = (F32::min(1024.0, F32::max(0.0, (self.fConst27 + fSlow11))) as i32);
		let mut iSlow13: i32 = (F32::min(1024.0, F32::max(0.0, (self.fConst28 + fSlow11))) as i32);
		let mut iSlow14: i32 = (F32::min(1024.0, F32::max(0.0, (self.fConst29 + fSlow11))) as i32);
		let mut iSlow15: i32 = (F32::min(1024.0, F32::max(0.0, (self.fConst30 + fSlow11))) as i32);
		let zipped_iterators = inputs0.zip(inputs1).zip(outputs0).zip(outputs1);
		for (((input0, input1), output0), output1) in zipped_iterators {
			self.fRec9[0] = ((0.200000003 * self.fRec9[1]) + (0.800000012 * self.fRec8[1]));
			self.fRec10[0] = (fSlow0 + (self.fConst2 * self.fRec10[1]));
			let mut fTemp0: F32 = ((0.00571428565 * self.fRec10[0]) + 0.699999988);
			self.fRec11[0] = (fSlow1 + (self.fConst2 * self.fRec11[1]));
			...
			self.fRec13[0] = ((0.200000003 * self.fRec13[1]) + (0.800000012 * self.fRec12[1]));
			...
			self.fRec15[0] = ((0.200000003 * self.fRec15[1]) + (0.800000012 * self.fRec14[1]));
			...
			self.fRec17[0] = ((0.200000003 * self.fRec17[1]) + (0.800000012 * self.fRec16[1]));
			...
			self.fRec19[0] = ((0.200000003 * self.fRec19[1]) + (0.800000012 * self.fRec18[1]));
			...
			self.fRec21[0] = ((0.200000003 * self.fRec21[1]) + (0.800000012 * self.fRec20[1]));
			...
			self.fRec23[0] = ((0.200000003 * self.fRec23[1]) + (0.800000012 * self.fRec22[1]));
			...
			self.fRec25[0] = ((0.200000003 * self.fRec25[1]) + (0.800000012 * self.fRec24[1]));
			...
			*output0 = ((fRec1 + self.fRec0[1]) as F32);
			self.fRec35[0] = ((0.200000003 * self.fRec35[1]) + (0.800000012 * self.fRec34[1]));
			self.fVec12[(self.IOTA & 8191) as usize] = (fTemp1 + (self.fRec35[0] * fTemp0));
			self.fRec34[0] = self.fVec12[((self.IOTA - iSlow3) & 8191) as usize];
			self.fRec37[0] = ((0.200000003 * self.fRec37[1]) + (0.800000012 * self.fRec36[1]));
			self.fVec13[(self.IOTA & 8191) as usize] = (fTemp1 + (self.fRec37[0] * fTemp0));
			self.fRec36[0] = self.fVec13[((self.IOTA - iSlow4) & 8191) as usize];
			self.fRec39[0] = ((0.200000003 * self.fRec39[1]) + (0.800000012 * self.fRec38[1]));
			self.fVec14[(self.IOTA & 8191) as usize] = (fTemp1 + (self.fRec39[0] * fTemp0));
			self.fRec38[0] = self.fVec14[((self.IOTA - iSlow5) & 8191) as usize];
			self.fRec41[0] = ((0.200000003 * self.fRec41[1]) + (0.800000012 * self.fRec40[1]));
			self.fVec15[(self.IOTA & 8191) as usize] = (fTemp1 + (self.fRec41[0] * fTemp0));
			self.fRec40[0] = self.fVec15[((self.IOTA - iSlow6) & 8191) as usize];
			self.fRec43[0] = ((0.200000003 * self.fRec43[1]) + (0.800000012 * self.fRec42[1]));
			self.fVec16[(self.IOTA & 8191) as usize] = (fTemp1 + (self.fRec43[0] * fTemp0));
			self.fRec42[0] = self.fVec16[((self.IOTA - iSlow7) & 8191) as usize];
			self.fRec45[0] = ((0.200000003 * self.fRec45[1]) + (0.800000012 * self.fRec44[1]));
			self.fVec17[(self.IOTA & 8191) as usize] = (fTemp1 + (self.fRec45[0] * fTemp0));
			self.fRec44[0] = self.fVec17[((self.IOTA - iSlow8) & 8191) as usize];
			self.fRec47[0] = ((0.200000003 * self.fRec47[1]) + (0.800000012 * self.fRec46[1]));
			self.fVec18[(self.IOTA & 8191) as usize] = (fTemp1 + (self.fRec47[0] * fTemp0));
			self.fRec46[0] = self.fVec18[((self.IOTA - iSlow9) & 8191) as usize];
			self.fRec49[0] = ((0.200000003 * self.fRec49[1]) + (0.800000012 * self.fRec48[1]));
			self.fVec19[(self.IOTA & 8191) as usize] = (fTemp1 + (self.fRec49[0] * fTemp0));
			self.fRec48[0] = self.fVec19[((self.IOTA - iSlow10) & 8191) as usize];
			...
			self.fRec32[0] = self.fVec20[((self.IOTA - iSlow12) & 2047) as usize];
			...
			self.fRec30[0] = self.fVec21[((self.IOTA - iSlow13) & 2047) as usize];
			...
			self.fRec28[0] = self.fVec22[((self.IOTA - iSlow14) & 2047) as usize];
			let mut fRec29: F32 = (0.0 - (0.5 * fTemp8));
			let mut fTemp9: F32 = (self.fRec28[1] + (fRec29 + (0.5 * self.fRec26[1])));
			self.fVec23[(self.IOTA & 2047) as usize] = fTemp9;
			self.fRec26[0] = self.fVec23[((self.IOTA - iSlow15) & 2047) as usize];
