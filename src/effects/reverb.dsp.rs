...
impl FaustDsp for reverb {
	...
	fn instance_constants(&mut self, sample_rate: i32) {
		...
		self.iConst3 = ((0.0269387756 * fConst0) as i32);
		self.iConst4 = ((0.0253061224 * fConst0) as i32);
		...
		self.iConst19 = (self.iConst5 + 23);
		self.iConst20 = (self.iConst6 + 23);
		self.iConst21 = (self.iConst7 + 23);
		self.iConst22 = (self.iConst8 + 23);
		self.iConst23 = (self.iConst10 + 23);
		self.iConst24 = (self.iConst4 + 23);
		self.iConst25 = (self.iConst3 + 23);
	...
	fn compute(&mut self, count: i32, inputs: &[&[Self::T]], outputs: &mut[&mut[Self::T]]) {
		...
		for (((input0, input1), output0), output1) in zipped_iterators {
			...
			self.fVec1[(self.IOTA & 8191) as usize] = ((fSlow1 * self.fRec12[0]) + fTemp0);
			...
			self.fVec7[(self.IOTA & 8191) as usize] = (fTemp0 + (fSlow1 * self.fRec24[0]));
			self.fRec23[0] = self.fVec7[((self.IOTA - self.iConst10) & 8191) as usize];
			let mut fTemp1: F32 = ((0.5 * self.fRec6[1]) + (self.fRec8[0] + (self.fRec11[0] + (self.fRec13[0] + (self.fRec15[0] + (self.fRec17[0] + (self.fRec19[0] + (self.fRec21[0] + self.fRec23[0]))))))));
